...
class SFNO2HEALPixForwardMapper(BaseMapper):
    ...
    def forward(
        ...
        x_src, x_dst, _, _ = self.pre_process(x, shard_shapes, model_comm_group, x_src_is_sharded, x_dst_is_sharded)
        ...
        x_out = self.post_process(x_out, None, model_comm_group, keep_x_dst_sharded)
